...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo" type="button" class="btn btn-info">Novo Especialidade</a>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if (@$_GET['funcao'] == 'editar') {
																	...
																	$res = $pdo->query("select * from especialidades where id = '$id_reg'");
