...
if($linhas_usuarios == 0){
  $res_insert = $pdo->query("INSERT into usuarios (nome, usuario, senha, senha_original, nivel)
    values ('Administrador', '$email_site', '$senha_cript', '$senha', 'admin')");
}
...
<section class="login-block">
  ...
  <div class="form-group">
    ...
    <input type="email"  name="usuario" class="form-control" placeholder="Digite seu e-mail" required>
